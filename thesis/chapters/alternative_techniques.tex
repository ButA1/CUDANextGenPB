...
The higher the order more accurate the expansion becomes to the original function.
For the expansion to be exact, the order needs to be infinite.

\subsection{Fast Multipole Method}
\label{sec:alternative-techniques-nbody-fmm}
%TODO include the origins of FMM
The Fast Multipole Method (FMM) takes the idea of Barnes-Hut and expands it to the target.
