...
I made four sweeps of $P$ and $\theta$ for values between 6 to 10 and 0.2 to 0.8 for both 6VYB (test1) and 1VSZ (test2) on my local machine,
...
For my local machine the measured optimal configurations for 6VYB (test1) and 1VSZ (test2) can be seen in Table~\ref{tab:fmm_ptheta_6vyb-pareto} and \ref{tab:fmm_ptheta_1vsz-pareto}.
...
For 1VSZ the most efficient config was $P=7$, $\theta=0.3$, $n_{leaf,src} = 16$ $n_{leaf,tgt} = 1024$.
