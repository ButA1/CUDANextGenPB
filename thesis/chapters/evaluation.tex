...
As already mentioned in \ref{sec:alternative-techniques-cuda-optimizations-mixed-precision}, FP64 performance on gaming/consumer such as the RTX 3080 is neutered when compared to the A100, despite both chips being part of the same architecture generation.
